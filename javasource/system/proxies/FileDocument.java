...
public class FileDocument
{
	...
	public static system.proxies.FileDocument initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("FlatFileInterface.ImportExportDocument", mendixObject.getType()))
			return flatfileinterface.proxies.ImportExportDocument.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("FlatFileInterface.ProcesFileQueue", mendixObject.getType()))
